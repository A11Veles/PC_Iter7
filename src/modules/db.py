...
class TeradataDatabase:
    ...
    def get_schema(self) -> str:
        ...
        try:
            result = execute_sql(query)
            if result.rowcount == 0:
                raise Exception("No schema data returned from database")
