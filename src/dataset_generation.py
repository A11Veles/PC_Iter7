...
def generate_dataset(test_mode=False):
    ...
    sectors_prompt = f"Search online and list the top {num_sectors} consumer product sectors (like those in malls/supermarkets, e.g., electronics, clothing, food). Provide as a numbered list."
